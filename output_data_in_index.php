<?php
    ...
    {
        case 1: $query = mysqli_query($connect, "SELECT id, name, author, date_of_writing FROM books WHERE status = 1 ORDER BY id DESC");    break;
        case 2: $query = mysqli_query($connect, "SELECT id, name, author, date_of_writing FROM books WHERE status = 0 ORDER BY id DESC");    break;
        case 3: $query = mysqli_query($connect, "SELECT id, name, author, date_of_writing FROM books ORDER BY id DESC");                     break;
    }
